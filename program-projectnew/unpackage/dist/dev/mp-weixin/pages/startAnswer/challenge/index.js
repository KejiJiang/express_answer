...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.sr("popupTop", "474269ef-1"),
    d: common_vendor.p({
      type: "message"
    }),
    e: common_vendor.p({
    ...
    f: common_vendor.sr("popupBottom", "474269ef-3"),
    g: common_vendor.p({
      type: "message"
    }),
    h: common_vendor.p({
    ...
    i: common_vendor.sr("submit", "474269ef-5"),
    j: common_vendor.p({
      type: "message"
    }),
    k: $data.isShowGlobal
    ...
    n: common_vendor.t($data.questionList.length),
    o: common_vendor.t($data.correctNumber),
    p: common_vendor.t($data.questionList.length - $data.correctNumber),
    q: common_vendor.o($options.gotoHome),
    r: common_vendor.p({
      round: true,
      icon: "wap-home",
      plain: true,
    ...
    v: common_vendor.o(($event) => $data.isShowTip = false),
    w: common_vendor.p({
      show: $data.isShowTip
    }),
    x: common_vendor.o($options.onClickLeft),
    y: common_vendor.o($options.gotoGlobal),
    z: common_vendor.p({
      title: "挑战模式",
      leftText: "返回",
      leftArrow: true,
    ...
    A: $data.questionList.length != 0
  }, $data.questionList.length != 0 ? {
    B: common_vendor.t($data.time)
  } : {}, {
    C: $data.questionList.length == 0
  }, $data.questionList.length == 0 ? {} : {}, {
    D: $data.questionList.length != 0
  }, $data.questionList.length != 0 ? {
    E: common_vendor.t($data.questionIndex + 1),
    F: common_vendor.t($data.questionList[$data.questionIndex].questionClass == "判断题" ? "判断题" : $data.questionList[$data.questionIndex].correctAnswer.length == 1 ? "单选题" : "多选题"),
    G: common_vendor.p({
      round: true,
      color: "#f9a825",
      size: "mini"
    }),
    H: common_vendor.t($data.questionList[$data.questionIndex].questionTitle)
  } : {}, {
    I: $data.questionList.length != 0
  }, $data.questionList.length != 0 ? common_vendor.e({
    J: $data.questionList[$data.questionIndex].questionClass == "选择题"
  }, $data.questionList[$data.questionIndex].questionClass == "选择题" ? {
    K: common_vendor.f($data.questionList[$data.questionIndex].option.split("#"), (item, index, i0) => {
      return {
    ...
    L: common_vendor.f(["正确", "错误"], (item, index, i0) => {
      return {
        a: common_vendor.t(item),
        b: common_vendor.o(($event) => $options.clickAnswer(item), index),
    ...
    M: $data.questionList.length != 0
  }, $data.questionList.length != 0 ? {
    N: common_vendor.o(($event) => $options.goto("prev")),
    O: common_vendor.p({
      round: true,
      color: $data.questionPrevColor
    }),
    P: common_vendor.o(($event) => $options.goto("next")),
    Q: common_vendor.p({
      round: true,
      color: $data.questionNextColor
    }),
    R: common_vendor.o(($event) => $options.submit("主动")),
    S: common_vendor.p({
      round: true,
      color: " #ffc400"
    })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/360MoveData/Users/lenovo/Desktop/scr/program-projectnew/pages/startAnswer/challenge/index.vue"]]);
