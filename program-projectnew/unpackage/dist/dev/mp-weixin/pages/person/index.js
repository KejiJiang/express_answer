...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.sr("noRecord", "7a4bd030-1"),
    d: common_vendor.p({
      type: "message"
    }),
    e: common_vendor.p({
    ...
    f: common_vendor.sr("sucessPicture", "7a4bd030-3"),
    g: common_vendor.p({
      type: "message"
    }),
    h: common_vendor.p({
    ...
    i: common_vendor.sr("errorPicture", "7a4bd030-5"),
    j: common_vendor.p({
      type: "message"
    }),
    k: $data.isShowChoosePicture
  }, $data.isShowChoosePicture ? {
    l: "url(" + $data.pictureUrl + ")",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/360MoveData/Users/lenovo/Desktop/scr/program-projectnew/pages/person/index.vue"]]);
