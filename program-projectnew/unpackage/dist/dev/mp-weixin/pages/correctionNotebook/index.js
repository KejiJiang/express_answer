    ...
    common_vendor.index.getStorage({
      ...
      success: (res) => {
        common_vendor.index.request({
          url: "http://localhost:3000/correctNoteBook",
          data: {
            username: res.data,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.sr("lastQuestion", "37f0e734-0"),
    c: common_vendor.p({
      type: "message"
    }),
    d: common_vendor.p({
    ...
    e: common_vendor.sr("firstQuestion", "37f0e734-2"),
    f: common_vendor.p({
      type: "message"
    }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/360MoveData/Users/lenovo/Desktop/scr/program-projectnew/pages/correctionNotebook/index.vue"]]);
