    ...
    common_vendor.index.getStorage({
      ...
      success: (res) => {
        ...
        common_vendor.index.request({
          url: `http://localhost:3000/starList?username=${this.who}&userId=${this.uid}`,
          method: "GET",
          success: (res2) => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.sr("popupTop", "5ae0f92b-0"),
    c: common_vendor.p({
      type: "message"
    }),
    d: common_vendor.p({
    ...
    e: common_vendor.sr("popupBottom", "5ae0f92b-2"),
    f: common_vendor.p({
      type: "message"
    }),
    g: common_vendor.p({
    ...
    h: common_vendor.sr("popupRemoveSuccess", "5ae0f92b-4"),
    i: common_vendor.p({
      type: "message"
    }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/360MoveData/Users/lenovo/Desktop/scr/program-projectnew/pages/starList/index.vue"]]);
